...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="metadata-iso19139.naplio-serviceview-simple">
    <xsl:call-template name="metadata-iso19139view-simple"/>
  </xsl:template>

  <xsl:template name="view-with-header-iso19139.naplio-service">
    <xsl:param name="tabs"/>
  ...
  <!-- Tab configuration -->
  <xsl:template name="iso19139.naplio-serviceCompleteTab">
  ...
  <xsl:template mode="iso19139.naplio-service" match="gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']"
    priority="3">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
