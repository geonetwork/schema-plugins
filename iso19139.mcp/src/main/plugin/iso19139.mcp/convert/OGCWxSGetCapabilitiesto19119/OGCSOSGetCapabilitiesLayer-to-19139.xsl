...
<xsl:stylesheet version="2.0"
	...
	xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:mcp="http://bluenet3.antcrc.utas.edu.au/mcp"
	...
	<xsl:include href="../../../../xsl/conversion/OGCWxSGetCapabilitiesto19119/resp-party.xsl" />
	<xsl:include href="../../../../xsl/conversion/OGCWxSGetCapabilitiesto19119/ref-system.xsl" />
	...
	<xsl:template match="*" mode="OfferingDataIdentification">
		...
		<xsl:for-each select="//sos:ObservationOffering[gml:name=$Name]/sos:procedure/@xlink:href">
			<mcp:sensor xlink:href="{.}"/>
		</xsl:for-each>
						...
						<mcp:DP_DataParameter>
							<mcp:parameterName>
								<mcp:DP_ParameterName>
									...
									<mcp:type>
										<mcp:DP_TypeCode codeList="http://bluenet3.antcrc.utas.edu.au/mcp/resources/Codelist/gmxCodelists.xml#DP_TypeCode" codeListValue="code">code</mcp:DP_TypeCode>
									</mcp:type>
								</mcp:DP_ParameterName>
							</mcp:parameterName>
							<mcp:parameterUnits>
								<mcp:DP_UnitsName>
									...
									<mcp:type>
										<mcp:DP_TypeCode codeList="http://bluenet3.antcrc.utas.edu.au/mcp/resources/Codelist/gmxCodelists.xml#DP_TypeCode" codeListValue=""/>
									</mcp:type>
								</mcp:DP_UnitsName>
							</mcp:parameterUnits>
