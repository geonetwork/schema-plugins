...
<xsl:stylesheet version="2.0" 
	...
	xmlns:mcp="http://bluenet3.antcrc.utas.edu.au/mcp" extension-element-prefixes="crs defcrs renv">
		...
		<mcp:MD_Metadata gco:isoType="gmd:MD_Metadata">
			...
			<identificationInfo>
				<srv:SV_ServiceIdentification>
					...
					<status>
						<xsl:choose>
							<xsl:when test="$temporalExtent/gmd:temporalElement/mcp:EX_TemporalExtent/gmd:extent/gml:TimePeriod/gml:endPosition/@indeterminatePosition[.='now']">
