...
<xsl:stylesheet   xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
	...
	<xsl:template match="mcp:MD_Commons[@mcp:commonsType='Data Commons' and normalize-space(mcp:licenseLink)='']">
	...
	<xsl:template name="fill">
		<xsl:copy>
			...
			<xsl:apply-templates select="mcp:derivativeConstraints"/>
			<xsl:apply-templates select="mcp:commercialUseConstraints"/>
			<xsl:apply-templates select="mcp:collectiveWorksConstraints"/>
