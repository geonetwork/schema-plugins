...
<xsl:stylesheet version="1.0" xmlns:xsl ="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:import href="metadata-taxonconcepts.mcp-2.0.xsl"/>
	<xsl:import href="metadata-iso19139.mcp-2.0-fop.xsl"/>
	<xsl:import href="metadata-iso19139.mcp-2.0-subtemplates.xsl"/>
  ...
  <xsl:template match="metadata-iso19139.mcp-2.0" name="metadata-iso19139.mcp-2.0">
	...
	<!-- ==================================================================== -->
	<!-- taxonomic info 																											-->
	<!-- NOTE: currently this template is not called - FIXME                  -->
	<!-- ==================================================================== -->
	...
	<xsl:template mode="iso19139.mcp-2.0" match="gmd:keyword[not(starts-with(following-sibling::gmd:thesaurusName/*/gmd:identifier/*/gmd:code/gmx:Anchor,'geonetwork.thesaurus.'))]">
  	<xsl:param name="schema"/>
    <xsl:param name="edit"/>
