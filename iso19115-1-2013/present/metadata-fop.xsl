...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:srv="http://www.isotc211.org/2005/srv/1.0/2013-03-28"
  ...
  <xsl:template name="metadata-fop-iso19115-1-2013-unused">
  ...
  <xsl:template name="metadata-fop-iso19115-1-2013">
    <xsl:param name="schema"/>
