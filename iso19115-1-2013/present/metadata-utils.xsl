...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- Display related metadata records. Related resource are only iso19115-1-2013/iso19139/119 or iso19110 metadate records for now.
	...
	<xsl:template name="relatedResources19115-1-2013">
		...
		<xsl:if test="starts-with(geonet:info/schema, 'iso19115-1-2013') or geonet:info/schema = 'iso19110'">
