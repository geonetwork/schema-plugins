...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	xmlns:gmi="http://sdi.eurac.edu/metadata/iso19139-2/schema/gmi" version="2.0">
...
<xsl:apply-templates select="." mode="schematron-select-full-path" />
	...
	<!--RULE -->
	<xsl:template match="//gmi:MI_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gmd:MD_Metadata']/gmd:hierarchyLevel"
		priority="1000" mode="M29">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
			context="//gmi:MI_Metadata/gmd:hierarchyLevel|//*[@gco:isoType='gmd:MD_Metadata']/gmd:hierarchyLevel" />
