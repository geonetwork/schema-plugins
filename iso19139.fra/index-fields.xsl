	...
	<xsl:template match="*" mode="metadata">
		...
		<xsl:for-each select="gmd:identificationInfo/fra:FRA_DataIdentification|gmd:identificationInfo/srv:SV_ServiceIdentification">
			...
			<xsl:for-each select="gmd:pointOfContact/gmd:CI_ResponsibleParty">
				<xsl:if test="gmd:organisationName/gco:CharacterString">
					<Field name="orgName" string="{string(gmd:organisationName/gco:CharacterString)}" store="true" index="true"/>
				</xsl:if>
				<xsl:if test="gmd:individualName/gco:CharacterString">
					<Field name="indName" string="{string(gmd:individualName/gco:CharacterString)}" store="true" index="true"/>
				</xsl:if>
			</xsl:for-each>
	  ...
	  <xsl:choose>
		...
		<xsl:for-each select="gmd:contact/gmd:CI_ResponsibleParty">
			<xsl:if test="gmd:organisationName/gco:CharacterString">
				<Field name="metadataPOC" string="{string(gmd:organisationName/gco:CharacterString)}" store="true" index="true"/>
			</xsl:if>
			<xsl:if test="gmd:individualName/gco:CharacterString">
				<Field name="indName" string="{string(gmd:individualName/gco:CharacterString)}" store="true" index="true"/>
			</xsl:if>
